          ...
          return (
            <Fragment key={i}>
              <div className={`group-box ${groupDraggable ? 'is-draggable' : ''}`}>
                        ...
                        <div className="group-wrapper">
                          <div className="group-draggable">
                            <Group
                              ...
                              steps={g.steps || []}
                              onStepClick={(stepIndex: number, step: IPipelineStepProps) => props.onStepClick?.(i, j, stepIndex, step)}
                              ...
                              onGroupClick={() => props.onGroupClick?.(i, j, g)}
                            />
                          </div>
                ...
                {allowParallelTask && (
                  <div className="pipeline-stage-allow-paralle flex-center cursor-pointer" onClick={() => props.onParallelTaskAdd?.(i, `pipeline-stage-${i + 1}-${group.length + 1}`)}>
                    增加并行阶段
                  </div>
                )}
              </div>
